...
<div class="card-body m-3 p-5">
    <h1 class="card-title text-center fw-bold" style="color: #FF6900">New Ressources</h1>
</div>
<div class="container text-white w-75 mb-5 p-4 rounded-2" style="background-color: #FF6900">
    <form action="newRessource" method="post" class="d-flex flex-column align-items-center">
        ...
        <div class=" mb-4 w-75">
            ...
            <input type="text" id="type" name="type" class="form-control w-100" />
        </div>
        ...
        <div class=" mb-4 w-75">
            ...
            <input type="text" id="supplier" name="supplier" class="form-control w-100" />
        </div>
        ...
        <div class="d-flex justify-content-end w-75">
            <button  type="submit" data-mdb-button-init
                     data-mdb-ripple-init class="btn btn-block btn-lg gradient-custom-4 text-body" style="background-color: #FFDFB9">Add Ressource</button>
        </div>
